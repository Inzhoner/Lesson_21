//- 1 ------------- Вікно, що випадає------------
alert('Hello world from first script.js');
...
console.log(messageOne); //виводимо значення змінної у консоль
...
let changeMessage = 'Працює заміна значення змінної';
messageTwo = changeMessage; // значення змінної changeMessage присвоюється змінної messageTwo
console.log(messageTwo); // виводимо у консоль

//- 4 ------------ Приклад застосування змінних (  let vs const  )------
console.log("Обчислення об'єму циліндра."); // Заголовок у консоль
//  V=π * r у квадраті * h --- формула обчислювання
...
//  V=π * r в квадрате * h
let V2;
const Pi2 = 3.1415926535; // зміна значення (3.1415926535 на будь яке, наприклад Pi2 = 123;) приведе до помилки
let r2 = 10;
let h2 = 20;

// Pi2 = 123; //! помилка, не можна міняти значення змінної const
...
// диапазон number від -9,007,199,254,740,992‬ до 9,007,199,254,740,992

// оголошуємо да даємо значення змінним
let xx = 100;
let yy = 20;

// або такий варіант - кому як подобається чи від необхідної ситуації
// let xx = 100; let yy = 20;
// let((xx = 100), (yy = 20)); 
// let(xx, yy)(100, 20);
// const [xx, yy] = [100, 20]; --- деструктуризації масиву
// const {xx, yy} = {xx: 100, yy: 20}; --- деструктуризації об'єкта
...
//         true:  не пустий рядок (навіть якщо є пробіл це вже не пустий рядок, а рядок з пробілом);
